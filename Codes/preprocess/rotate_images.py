...
subfolder_train = 'data/train-resized-256/'
...
if __name__ == '__main__':
    ...
    trainLabels = pd.read_csv(root_dir+'labels/trainLabels_master.csv')
    ...
    mirror_images(root_dir+subfolder_train, 1, lst_imgs_no_DR)


    # Rotate all images that have any level of DR
    print("Rotating 90 Degrees")
    rotate_images(root_dir+subfolder_train, 90, lst_imgs_DR)

    print("Rotating 120 Degrees")
    rotate_images(root_dir+subfolder_train, 120, lst_imgs_DR)

    print("Rotating 180 Degrees")
    rotate_images(root_dir+subfolder_train, 180, lst_imgs_DR)

    print("Rotating 270 Degrees")
    rotate_images(root_dir+subfolder_train, 270, lst_imgs_DR)

    print("Mirroring DR Images")
    mirror_images(root_dir+subfolder_train, 0, lst_imgs_DR)
